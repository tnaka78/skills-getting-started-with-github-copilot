...
activities = {
    ...
    "Basketball": {
        "description": "Team sport focusing on basketball skills and game strategies",
    ...
    "Music Ensemble": {
        "description": "Perform and collaborate with other musicians in various genres",
    ...
    "Robotics Club": {
        "description": "Design, build, and program robots to solve engineering challenges",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["robert@mergington.edu", "henry@mergington.edu"]
    }
}
